...
protobuf.parse            = __webpack_require__(651);
...
const OneOf = __webpack_require__(598);
var util = __webpack_require__(935);
...
var tokenize  = __webpack_require__(455),
    ...
    ReflectionObject = __webpack_require__(243),
    types     = __webpack_require__(63),
    util      = __webpack_require__(935);
...
(() => {
/* harmony import */ var protobufjs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(281);
...
function decodeMigrationUrl(migrationUrl) {
    ...
    const buffer = new Uint8Array(protobufjs__WEBPACK_IMPORTED_MODULE_0___default().util.base64.length(payload));
    protobufjs__WEBPACK_IMPORTED_MODULE_0___default().util.base64.decode(payload, buffer, 0);

    const { root } = protobufjs__WEBPACK_IMPORTED_MODULE_0___default().parse(MigrationPayloadMessageProto);
